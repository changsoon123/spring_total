...
public class BoardController {
    ...
    public void list(Model model) {
    	...
    	model.addAttribute("sList", service.getArticles());
    ...
    public void content(int boardNo,Model model) {
    	System.out.println("상세보기: " + boardNo);
    	model.addAttribute("cList", service.getArticle(boardNo));
    }
    ...
    public void modify(int boardNo,Model model) {
    	System.out.println("수정 요청 번호: " + boardNo);
    	model.addAttribute("cList", service.getArticle(boardNo));
    }
    ...
    public String delete(int boardNo,RedirectAttributes ra) {
		System.out.println("삭제할 게시물 번호: " + boardNo);
		service.deleteArticle(boardNo);
		ra.addFlashAttribute("msg","delcom");
